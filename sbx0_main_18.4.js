(() => {
  ...
  sbx0_offsets = {
   ...
   "iPad14,1_22F76": {
      GPUConnectionToWebProcess_CreateGraphicsContextGL: 0x29,
      GPUConnectionToWebProcess_CreateRenderingBackend: 0x2b,
      InitializeConnection: 0xbdb,
      ProcessOutOfStreamMessage: 0xbdd,
      RemoteDisplayListRecorder_DrawGlyphs: 0x3cc,
      RemoteDisplayListRecorder_FillRect: 0x3e1,
      RemoteDisplayListRecorder_SetCTM: 0x3ec,
      RemoteDisplayListRecorder_StrokeRect: 0x400,
      RemoteGraphicsContextGLProxy_WasCreated: 0x40a,
      RemoteGraphicsContextGL_AttachShader: 0x40e,
      RemoteGraphicsContextGL_BindBuffer: 0x413,
      RemoteGraphicsContextGL_BindTexture: 0x419,
      RemoteGraphicsContextGL_BufferData0: 0x426,
      RemoteGraphicsContextGL_BufferData1: 0x427,
      RemoteGraphicsContextGL_BufferSubData: 0x428,
      RemoteGraphicsContextGL_CompileShader: 0x434,
      RemoteGraphicsContextGL_CreateBuffer: 0x441,
      RemoteGraphicsContextGL_CreateProgram: 0x443,
      RemoteGraphicsContextGL_CreateShader: 0x448,
      RemoteGraphicsContextGL_CreateTexture: 0x449,
      RemoteGraphicsContextGL_Finish: 0x471,
      RemoteGraphicsContextGL_Flush: 0x472,
      RemoteGraphicsContextGL_GetBufferSubDataInline: 0xf10,
      RemoteGraphicsContextGL_GetShaderSource: 0xf28,
      RemoteGraphicsContextGL_LinkProgram: 0x47c,
      RemoteGraphicsContextGL_PixelStorei: 0x484,
      RemoteGraphicsContextGL_Reshape: 0x48f,
      RemoteGraphicsContextGL_ShaderSource: 0x498,
      RemoteGraphicsContextGL_TexImage2D1: 0x4a1,
      RemoteGraphicsContextGL_UseProgram: 0x4cf,
      RemoteGraphicsContextGL_VertexAttrib4f: 0x4d7,
      RemoteImageBufferProxy_DidCreateBackend: 0x4e2,
      RemoteImageBuffer_PutPixelBuffer: 0x4e8,
      RemoteRenderingBackendProxy_DidInitialize: 0x5a6,
      RemoteRenderingBackend_CacheFont: 0x5aa,
      RemoteRenderingBackend_CreateImageBuffer: 0x5ae,
      RemoteRenderingBackend_ReleaseImageBuffer: 0x5be,
      RemoteRenderingBackend_ReleaseRenderingResource: 0x5c3,
      SyncMessageReply: 0xbdf,
      WebProcessProxy_GPUProcessConnectionDidBecomeUnresponsive: 0xacc
   }
};
  ...
  (function SBX0() {
    ...
    // CRITICAL: fontIdentifier 需人工填入真实值（从目标固件 CoreText.framework 逆向获取）
    // 当前 0x1234n 是占位值，会导致 font cache 失败
    let fontIdentifier = 0x1234n; // TODO: Replace with real fontIdentifier from target build
    LOG(`fontIdentifier: ${fontIdentifier.hex()} (PLACEHOLDER - needs manual extraction)`);
    function cacheFont() {
